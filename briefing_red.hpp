...
<*> There are no <FO> Forward Outposts<br />
<br />

<titleFont>Deployment Options:</titleFont><br />
<boxes> Forward Base (F.O. Bear)<br />
<FO> Forward Outpost (not available)<br />
<RP> Team Rally Point<br />
<HO> Hideout (not available)<br />
<br />

<titleFont>Strategies:</titleFont><br />
<*> This is a CQB with tight zones<br />
<*> Make sure your SL has SL kit<br />
<br />